...
INSERT INTO `employees` (`id`, `first_name`, `last_name`, `department`, `designation`, `password`, `gender`, `email`, `address`, `post_code`, `city_pro`, `profile_pic`, `department_id`, `designation_id`, `mobile_no`, `status`, `occupation`, `create_by`, `created_date`, `modified_by`, `modified_date`) VALUES
(1, 'Chandan', 'Kumar', 'IT', 'Teacher', '123', 'male', 'mrcwebservices@gmail.com', 'njkn                                       ', 'r3m1p6', 'wpg, MB', '0.jpg', 0, 0, '4315886395', 1, 'blue_team', 'razu@admin ', '2020-04-06 05:00:00', NULL, NULL);
